...
(
  ...
  COMMENT = '椅子情報テーブル';
ALTER TABLE chairs ADD INDEX idx_owner (owner_id);
...
ALTER TABLE chair_locations ADD INDEX idx_chair_created (chair_id, created_at DESC);
ALTER TABLE chair_locations ADD INDEX idx_created (created_at);
...
(
  ...
  COMMENT = 'ライド情報テーブル';
ALTER TABLE rides ADD INDEX idx_chair_created (chair_id, created_at DESC);
...
ALTER TABLE ride_statuses ADD INDEX idx_ride_create (ride_id, created_at DESC);
